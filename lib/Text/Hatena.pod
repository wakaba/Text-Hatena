...
=item <a data-hatena-embed data-hatena-lang>

The C<data-hatena-oembed> attribute is a boolean attribute
representing whether the link is expected to be expanded to "embeded"
