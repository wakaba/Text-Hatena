...
build_inlines {
    ...
    syntax qr{\[(b:keyword:([^\]]+))\]}ix => sub {
        ...
        $keyword =~ s{%2f}{/}ig;
        qq{<a href="https://b.hatena.ne.jp/keyword/$keyword">$name</a>};
    };
    ...
    syntax qr{\[(b:id:($UNAME_PATTERN):t:([^\]]+))\]}ix => sub {
        ...
        qq{<a href="https://b.hatena.ne.jp/$username/$tag/">$name</a>};
    };
    ...
    syntax qr{\[(b:t:([^\]]+))\]}ix => sub {
        ...
        $tag = encode_entities($tag);
        qq{<a href="https://b.hatena.ne.jp/t/$tag">$name</a>};
    };
    ...
    syntax qr/\[?((?<![[:alnum:]])b:id:($UNAME_PATTERN)(?::(favorite|asin|\d+))?)\]?/ix => sub {
        ...
        $type ||= '';
        qq{<a href="https://b.hatena.ne.jp/$username/$type">$name</a>};
    };
};
